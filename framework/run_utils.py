...
def find_best_val_models(log_dir, model_dir):
    ...
    for measure_name in measure_names:
        ...
        # for metrics: the higher the better
            ...
            reg = 100 if 'nDCG' in measure_name or 'mAP' in measure_name else 1  # nDCG & mAP are in [0, 1], R@k are in [0, 100]
            idx = np.argmax([scores[measure_name] * reg for scores in val_scores])

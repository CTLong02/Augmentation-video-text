...
def main():
    ...
    if opts.is_train:
        ...
        trn_dataset = t2vretrieval.readers.mpdata.MPDataset(path_cfg.name_file['trn'],
                                                            path_cfg.mp_ft_files['trn'], path_cfg.word2int_file,
        ...
        val_dataset = t2vretrieval.readers.mpdata.MPDataset(path_cfg.name_file['val'],
                                                            path_cfg.mp_ft_files['val'], path_cfg.word2int_file,
                                                            model_cfg.max_words_in_sent,
                                                            ref_caption_file=path_cfg.ref_caption_file['val'],
        ...
        tst_dataset = t2vretrieval.readers.mpdata.MPDataset(path_cfg.name_file[opts.eval_set],
                                                            path_cfg.mp_ft_files[opts.eval_set], path_cfg.word2int_file,
                                                            model_cfg.max_words_in_sent,
                                                            ref_caption_file=path_cfg.ref_caption_file[opts.eval_set],
                                                            is_train=False, _logger=_logger)
